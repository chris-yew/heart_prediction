...
creatinine_phosphokinase = st.sidebar.number_input("Creatinine phosphokinase",step=1)
ejection_fraction = st.sidebar.number_input("Ejection fraction",step=1)
platelets = st.sidebar.number_input("Platelets")
serum_creatine = st.sidebar.number_input("Serum creatinine",step=0.1)
serum_sodium = st.sidebar.number_input("Serum sodium",step=1)
time = st.sidebar.number_input("Time",step=1)
